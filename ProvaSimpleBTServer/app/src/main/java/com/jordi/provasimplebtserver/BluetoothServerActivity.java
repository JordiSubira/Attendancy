...
public class BluetoothServerActivity extends Activity {
    ...
    private static final UUID MY_UUID = UUID.fromString("00001122-0000-1000-8000-00805F9B34FB");
    ...
    public void manageConnectedSocket(BluetoothSocket socket) {
        ...
        ConnectedThread server = new ConnectedThread(mHandler, socket,macAddress);
        server.start();
    }
